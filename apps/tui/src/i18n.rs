...
pub const TABLE: &[(&str, &str, &str)] = &[
    ...
    ("block.turn_done", "已读 {0} 字  ·  {1}s", "read {0} chars  ·  {1}s"),
    ("block.interrupted", "已中断", "interrupted"),
    ("block.chapter_done", "本章读完：{0}  ·  {1} 字", "chapter done: {0}  ·  {1} chars"),
    ...
    ("lib.imported", "{0}：《{1}》 → {2}（{3} 字、{4} 章）",
        "{0}: {1} → {2} ({3} chars, {4} chapters)"),
    ("lib.import_note", "{0}：《{1}》 → {2}（第 {3} 本，{4} 字）",
        "{0}: {1} → {2} (#{3}, {4} chars)"),
    ...
    ("cmd.progress", "《{0}》 {1}%  ·  {2} / {3} 字  ·  第 {4} 章第 {5} 段",
        "{0} — {1}%  ·  {2} / {3} chars  ·  chapter {4}, paragraph {5}"),
    ...
    ("tts.rate_set", "朗读速率：{0}×", "Speech rate: {0}×"),
    ...
    ("tts.usage_rate", "用法：/rate <0.5-3.0>", "Usage: /rate <0.5-3.0>"),
    ...
    ("flow.chapter_start", "进入第 {0} 章「{1}」，一共 {2} 段、约 {3} 字。先读开头 {4} 段，建立上下文。",
        "Entering chapter {0} ({1}): {2} paragraphs, about {3} chars. Read the first {4} to get the shape."),
    ("flow.continue", "{0}接着第 {1} 段往下，这一轮约 {2} 字，{3}。",
        "{0}Continuing from paragraph {1}; about {2} chars this turn, {3}."),
    ...
    ("flow.hits_intro", "「{0}」在书里出现 {1} 处，挑最相关的几段：\n",
        "\"{0}\" appears {1} times. The most relevant passages:\n"),
    ...
    ("flow.welcome_fresh", "已载入《{0}》，{1} 章、约 {2} 字。回车开始读，/help 看命令。",
        "Loaded {0}: {1} chapters, about {2} chars. Enter starts reading; /help lists commands."),
    ...
    ("flow.think_chapter_start", "进入第 {0} 章「{1}」，一共 {2} 段、约 {3} 字。先读开头 {4} 段，建立上下文。",
        "Into chapter {0} ({1}): {2} paragraphs, about {3} chars. Reading the first {4} to establish context."),
    ("flow.think_continue", "{0}接着第 {1} 段往下，这一轮约 {2} 字，{3}。",
        "{0}Continuing from paragraph {1}; about {2} chars this turn, {3}."),
    ...
    ("flow.hit_location", "第 {0} 章「{1}」第 {2} 段\n", "chapter {0} ({1}), paragraph {2}\n"),
    ("flow.where_to_start", "\n要从哪一处开始读？", "\nWhere would you like to start?"),
    ("flow.goto_hint", "直接 /goto {0} 会跳到第一处所在的章；", "/goto {0} jumps to the chapter holding the first hit; "),
    ("flow.goto_para", "那一处在第 {0} 段。", "that hit is in paragraph {0}."),
    ("flow.toc_intro", "列一下目录：{0} 章，合计约 {1} 字。",
        "Listing the contents: {0} chapters, about {1} chars in total."),
